...
$t = [
    'es' => [
        ...
        'subtitle' => 'Registros Educativos de tu Hijo',
        'desc' => 'Como padre o tutor puedes ver o corregir los registros educativos de tu hijo. Usa este formulario y te ayudamos en pocos pasos.',
        'what_is_ferpa' => '¿Qué puedes hacer aquí?',
        'ferpa_info' => 'Protegemos la privacidad de los datos escolares de los menores. Tienes derecho a acceder y, si hace falta, corregir la información.',
        'right_access' => 'Ver registros',
        'right_access_desc' => 'Solicitar una copia de los registros educativos de tu hijo.',
        'right_correction' => 'Corregir datos',
        'right_correction_desc' => 'Pedir que corrijamos información que consideres incorrecta.',
        'label_type' => 'Tipo de Solicitud',
        'opt_access' => 'Ver registros de mi hijo',
        'opt_correction' => 'Corregir un dato incorrecto',
        'label_email' => 'Tu correo (padre o tutor)',
        'placeholder_email' => 'ejemplo@correo.com',
        'label_phone' => 'Tu teléfono',
        'placeholder_phone' => 'Ej: 555-123-4567',
        'phone_help' => 'Los usamos solo para comprobar que eres tú.',
    ...
    'en' => [
        ...
        'subtitle' => 'Your Child\'s Education Records',
        'desc' => 'As a parent or guardian you can view or correct your child\'s education records. Use this form and we\'ll help you in a few steps.',
        'what_is_ferpa' => 'What can you do here?',
        'ferpa_info' => 'We protect the privacy of students\' school data. You have the right to access and, when needed, correct the information.',
        'right_access' => 'View records',
        'right_access_desc' => 'Request a copy of your child\'s education records.',
        'right_correction' => 'Correct data',
        'right_correction_desc' => 'Ask us to correct information you believe is wrong.',
        'label_type' => 'Request Type',
        'opt_access' => 'View my child\'s records',
        'opt_correction' => 'Correct inaccurate data',
        'label_email' => 'Your email (parent or guardian)',
        'placeholder_email' => 'example@email.com',
        'label_phone' => 'Registered Phone Number',
        'placeholder_phone' => 'Ex: 555-123-4567',
        'phone_help' => 'We use it only to confirm it\'s you.',
